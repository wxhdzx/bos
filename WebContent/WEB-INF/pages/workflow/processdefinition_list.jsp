  		...
  		<tbody>
  				...
  				<tr>
  					...
  					<td>
  						<script type="text/javascript">
  							function show(){
  								window.open('processDefinitionAction_showpng?id=${id }');  
  							/*window.showModalDialog('processDefinitionAction_showpng?id=${id}');*/
  							
  							}
  							//定义一个删除的方法
  							function del(id){
  								//给一个提示信息
  								$.messager.confirm("确认信息","你确定删除当前元素吗",function(r){
  									if(r){
  						...
  						<!-- 添加一个删除按钮 -->
  						<a onclick="del('${id}')" 
  								class="easyui-linkbutton" dada-options="iconCls:'icon-remove'">
  								删除
  						</a>
  					</td>
  				</tr>
